...
class ItemRepositoryTest {
    ...
    void findAllByOwnerIdTest() {
        ...
        Page<Item> items = itemRepository.findAllByOwnerIdOrderByIdAsc(user.getId(), Pageable.ofSize(10));
    ...
    void findAllCommentByItemIdTest() {
        ...
        commentRepository.save(Comment.builder().text("comment").item(item).author(user2)
